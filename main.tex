...
\subsection*{Motorola 68CH11}
This system did not use cache memory.


\subsection*{intel i960}
This system used cache memory for instructions and data. The instruction cache size completely depended on the model of the CPU, but generally it ranged between 512 bytes to 4KB, meanwhile the data cache ranged from 0 to 2KB.
...
\url{https://github.com/bfox9900/MaxForth-68hc11?}
\url{https://grokipedia.com/page/Motorola_68HC11}
